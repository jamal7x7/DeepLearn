...
export default function DashboardLayout({
  ...
  const navItems = [
    { href: '/settings-dashboard', icon: Users, label: 'Team' },
    { href: '/settings-dashboard/general', icon: Settings, label: 'General' },
    { href: '/settings-dashboard/activity', icon: Activity, label: 'Activity' },
    { href: '/settings-dashboard/security', icon: Shield, label: 'Security' },
  ];
