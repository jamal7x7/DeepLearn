    ...
    <div className="min-h-[100dvh] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 ">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <Triangle className="h-12 w-12 text-orange-500" />
        </div>
          ...
          <div className="mt-6">
            <Link
              href={`${mode === 'signin' ? '/sign-up' : '/sign-in'}${redirect ? `?redirect=${redirect}` : ''
                ...
                className="w-full flex justify-center rounded-md border rad items-center py-2 px-4 shadow-sm text-sm font-medium"  >
              {mode === 'signin'
                ? 'Create an account'
