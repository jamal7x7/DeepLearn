...
import { Play, Square, ZoomIn, ZoomOut, RefreshCw } from 'lucide-react';
                ...
                <div className="w-2/3 h-full flex flex-col gap-4">
                    ...
                    >
                        <div className="absolute bottom-2 right-2 z-10 flex gap-1">
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button onClick={handleZoomIn} variant="outline" size="icon" className="h-8 w-8 bg-background/50 hover:bg-background/75" aria-label="Zoom In">
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button onClick={handleZoomOut} variant="outline" size="icon" className="h-8 w-8 bg-background/50 hover:bg-background/75" aria-label="Zoom Out">
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button onClick={handleResetZoom} variant="outline" size="icon" className="h-8 w-8 bg-background/50 hover:bg-background/75" aria-label="Reset Zoom">
