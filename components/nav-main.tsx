          ...
          {items
            ...
            <SidebarMenuItem key={item.title}>
              ...
              {item.items && item.items.length > 0 ? (
                // Accordion-style menu for any item with submenu
                <>
                  <SidebarMenuButton
                    asChild
                    tooltip={item.title}
                    ...
                    <div className="flex w-full items-center gap-2 cursor-default select-none">
                      {item.icon && (
                        <div className="relative">
                          ...
                          <span className="absolute -inset-1 rounded-full bg-primary/10 blur-sm -z-10 opacity-0 group-hover/sidebar-accordion:opacity-100 transition-opacity duration-300"></span>
                        </div>
                      )}
